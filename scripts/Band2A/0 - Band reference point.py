...
cross_config = mrsobs.MIRI_internal_calibration_source(lvl2path,'2AxB',campaign='FM',output='img')
nomin_config = mrsobs.MIRI_internal_calibration_source(lvl2path,'2A',campaign='FM',output='img')
